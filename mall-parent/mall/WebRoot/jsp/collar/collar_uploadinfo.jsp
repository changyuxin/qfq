	                ...
	                <!--上传资料-->
	                	<p class="p_mian_title">
		                	<s:if test="collarQuery.uploadCardDetail!=null">
		                		<strong>上传资料<font color="red">(已上传资料)</font></strong>
		                	</s:if>
		                	<s:else>
		                		<strong>上传资料<font color="red">(请上传资料)</font></strong>
		                	</s:else>
	                	</p>
	                    <!--error窗口-->
	                    <div class="error-div error-span" style="display:none;" id="errorUploadInfoTxt"></div>
	                    <p class="p_mian" style="margin-top:20px;"><label>身份证（正反面）：</label>
	                    	<input type="file" class="white-collar-file" id="upload1" name="upload" labelName="身份证（正面）" onblur="checkInputText6(this);"/> 
	                        <input type="file" class="white-collar-file" id="upload2" name="upload" labelName="身份证（反面）" onblur="checkInputText6(this);"/></p>
