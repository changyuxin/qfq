...
<body>
		<div style="border-bottom: 1px solid #ccc; padding: 5px; text-align: right;">
			<input id="printbtn" type="button" value="打印合同" />
		</div>
		<div id="detail">
    					...
    					<tr>
    						<td>
            					<table border="0" cellpadding="0" cellspacing="0" width="100%">
                        			<tbody>
                        				<tr>
                            				<td width="100%"><p style="text-align:right; height: 40px;">合同编号：${contractQuery.code}</p></td>
                        				</tr>
                        				<tr>
    						...
    						<td>
        						<table border="0" cellpadding="0" cellspacing="0" width="100%" align="center" style="font-size: 10.5pt;">
            						<tbody>
                         				...
                         				<tr>
                                			<td colspan="2" width="350px" height="40px" align="left">乙方：${contractQuery.belong}</td>
                                			<td colspan="3" width="350px" height="40px" align="left">身份证号：${contractQuery.idCard}</td>
                                			<td colspan="3" width="250px" height="40px" align="center">手机号码：${contractQuery.phone}</td>
                            			</tr>   
                         				<tr>
      						...
      						<td>
    							<table border="1" cellpadding="0" cellspacing="0" width="100%">
           							<tbody>
                         				...
                         				<tr>
                             				<td colspan="5" align="center" height="40px"><b>${contractQuery.productName}</b></td>
                             				<td colspan="1" align="center" height="40px"><b>${contractQuery.quantity}</b></td>
                             				<td colspan="2" align="center" height="40px"><b>${contractQuery.productPrice}元</b></td>
                         				</tr>
                                        <tr>
                                             <td colspan="1" width="16%" height="40px" align="center">首付金额</td>
                                             <td colspan="1" width="16%" height="40px" align="center"><strong>${contractQuery.firstPay}</strong>元</td>
                                             <td colspan="1" width="16%" height="40px" align="center">分期月数</td>
                                             <td colspan="2" width="16%" height="40px" align="center"><strong>${contractQuery.months}</strong>个月</td>
                                             <td colspan="1" width="20%" height="40px" align="center">每月付款金额</td>
                                             <td colspan="2" width="16%" height="40px" align="center"><strong>${contractQuery.monthPay}</strong>元</td>
                                         </tr>
                                        <tr>
                                             <td colspan="2" align="center" height="40px">每月还款日</td>
                                             <td colspan="1" width="150px"  height="40px" align="center">每月<strong>${contractQuery.paymentDay}</strong>日</td>
                                        ...
                                        <tr>
                                             ...
                                             <td colspan="3" width="120px"  height="40px" align="center">
                                             	<input type="hidden" value="${contractQuery.monthPay * contractQuery.months}" id="total" />
                                             	<strong id="totalCost">${contractQuery.monthPay * contractQuery.months}</strong>元
                                             </td>
                                         </tr>
                                        <tr>
                                             <td colspan="5" align="left" height="40px">&nbsp;&nbsp;乙方应付款总额中包含的甲方收取的服务费，第三方融资平台收取的服务费（由甲方代收）</td>
                                             <td colspan="3" width="120px"  height="40px" align="center">
                                             	<input type="hidden" value="${(contractQuery.productPrice - contractQuery.firstPay ) * contractQuery.serviceRate}" id="servicePay" />
                                             	<strong id="serviceCost"></strong>元
                                             </td>
                                         </tr>
                                         <tr>
                                             <td colspan="5" align="left" height="40px">&nbsp;&nbsp;乙方应付款总额中包含的甲方收取的财务费，第三方融资平台收取的财务费（由甲方代收）</td>
                                             <td colspan="3" width="120px"  height="40px" align="center">
                                             	<input type="hidden" value="${(contractQuery.productPrice - contractQuery.firstPay ) * contractQuery.financialRate}" id="financialPay" />
                        ...
                        <tr>
                            <td style="font-size:14px;line-height:30px !important;">
                             ...
                             <p>&nbsp;&nbsp;&nbsp;&nbsp;1、乙方应向甲方支付第一条所述首付（如有）。</p>
 			     			 <p>&nbsp;&nbsp;&nbsp;&nbsp;2、乙方有权申请提前还款，申请提前还款成功的，余下期数未发生的月服务费的50%，只需要还清应付款总额减去已经偿还的金额再减去余下期数月服务费的金额即可。</p>
