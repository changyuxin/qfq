...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body style="overflow:scroll;" > 
		<form id="uploadForm" method="post" enctype="multipart/form-data" action="member/member!uploadSpyPhoto.do">
			...
			<div style="float: left; width: 99%">
				<div style="float: left; padding-left: 20px; width: 50%">
					...
					<input type="hidden" value="<s:property value="memberQuery.memberId"/>" name="memberQuery.memberId" id="memberId"/>
				</div>
