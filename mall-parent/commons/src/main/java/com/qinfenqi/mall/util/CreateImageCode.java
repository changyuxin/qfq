...
public class CreateImageCode {
	 ...
	 * @return
	 */
	public static InputStream getImageAsInputStream(String securityCode) {
		BufferedImage image = createImage(100, 38, securityCode);
		return readImageToInputStream(image);
	}
	 ...
	 * @return
	 */
	private static InputStream readImageToInputStream(BufferedImage image) {
		InputStream is = null;
